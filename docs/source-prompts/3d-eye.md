...
- Near-black grid background with subtle scan lines and corner registration marks.
- Neon green terminal glow for active paths, selected cards, locks, arrows, and status text.
