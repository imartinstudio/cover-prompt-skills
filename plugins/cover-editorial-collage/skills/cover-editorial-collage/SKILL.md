...
If generating the image directly, keep all theme analysis internal and output only the generated image result. If the user explicitly asks for a prompt, output only the final image prompt.
